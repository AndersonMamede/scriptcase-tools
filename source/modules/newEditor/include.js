...
(function(){
	...
	var includeNewEditor = function(sctSettings, content){
		window.appendScript(document, function(
			...
			var editorLoaded = new Promise(function(resolve, reject){
				var currentLoopCount = 0, maxLoopCount = 500;
				var editorReadyInterval = setInterval(function(){
					if(typeof editor != "undefined" || ++currentLoopCount > maxLoopCount){
