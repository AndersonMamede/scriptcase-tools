...
$(document).ready(function(){
	...
	var modalContent = {
		...
		"extensionIsNotNecessary" : [
			...
			"Therefore, this extension will not be necessary for ScriptCase v9 and it will stay disabled for ScriptCase >= ",
			"v9. You will still be able to use this extension for ScriptCase <strong>v7 and v8</strong>.<br><br>",
